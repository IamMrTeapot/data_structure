...
class list
{
  ...
  public:
    ...
    list(const list<T>& a ) :
      ...
      std::cout << "printing copying constructor " << mSize << "\n";
      for (auto &x : *this) {
        push_back(x);
        std::cout << "printing forloop in copying constructor " << mSize << "\n";
    ...
    list<T>& operator=(list<T> other) {
      ...
      std::cout << "printing other.mSize in constructor " << other.mSize << "\n\n";
      using std::swap;
      swap(this->mHeader, other.mHeader);
      swap(this->mSize, other.mSize);
      std::cout << "printing mSize in constructor " << mSize << "\n\n";
      return *this;
    }
